...
const AnalysisResult = ({ imageUrl, onBack, onHome }: AnalysisResultProps) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className={`px-5 pt-12 pb-8 rounded-b-[2rem] ${result.isClean ? "gradient-success" : "gradient-warning"}`}>
        <button
          onClick={onBack}
        ...
        <h1 className="text-2xl font-bold text-primary-foreground">Analysis Result</h1>
      </div>

      <div className="px-5 py-6">
        {/* Image Preview */}
        <div className="relative rounded-2xl overflow-hidden shadow-card mb-6 h-48">
          <img
            src={imageUrl}
            alt="Analyzed food"
